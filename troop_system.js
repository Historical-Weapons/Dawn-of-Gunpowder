...
init: function() {
    ...
    this.create("Bomb", "Bomb", ROLES.BOMB, false, { desc: "Thrown by hand or via a staff sling, the 'Thunder Crash Bomb' was an early blackpowder bomb first depicted in a late 12th century artwork 揭缽圖卷, though some historians have argued a much earlier date of around 950AD with controversy. The 13th century version were iron-cased explosives packed with fast burning black powder. Ignited with a slow match, these volatile spheres produce a concussive shockwave and flesh-tearing shrapnel, capable of shattering enemy morale and weakening tight infantry squares. However early bombs of this era were not particularly lethal and still required a brave melee charge.", weightClass: WEIGHT_CLASSES.LIGHT_INF, isRanged: true, ammo: 2, health: 80, meleeAttack: 8, meleeDefense: 8, missileBaseDamage: 50, missileAPDamage: 10, accuracy: 50, armor: ARMOR_TIERS.CLOTH, speed: 0.9, range: 330, morale: 100, cost: 105 });
