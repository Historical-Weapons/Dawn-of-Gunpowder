...
init: function() {
        // --- BASE MILITIA (Tier 0) ---
        this.create("Militia", "Militia", ROLES.INFANTRY, false, { weightClass: WEIGHT_CLASSES.LIGHT_INF, health: 80, meleeAttack: 5, meleeDefense: 1, armor: ARMOR_TIERS.CLOTH, speed: 1.1, range: 25, morale: 35, cost: 5 });

        // --- CROSSBOW LINE ---
        this.create("Crossbowman", "Crossbowman", ROLES.CROSSBOW, false, { weightClass: WEIGHT_CLASSES.LIGHT_INF, isRanged: true, ammo: 30, health: 100, meleeAttack: 10, meleeDefense: 5, missileBaseDamage: 12, missileAPDamage: 28, accuracy: 65, armor: ARMOR_TIERS.PARTIAL_LAMELLAR, speed: 0.7, range: 700, morale: 50, cost: 35 });
        this.create("Heavy Crossbowman", "Heavy Crossbowman", ROLES.CROSSBOW, false, { weightClass: WEIGHT_CLASSES.HEAVY_INF, isRanged: true, ammo: 25, health: 140, meleeAttack: 14, meleeDefense: 14, missileBaseDamage: 15, missileAPDamage: 30, accuracy: 70, armor: ARMOR_TIERS.FULL_LAMELLAR, speed: 0.6, range: 800, morale: 65, cost: 50 });
        this.create("Bomb", "Bomb", ROLES.BOMB, false, { weightClass: WEIGHT_CLASSES.LIGHT_INF, isRanged: true, ammo: 2, health: 100, meleeAttack: 8, meleeDefense: 8, missileBaseDamage: 30, missileAPDamage: 100, accuracy: 50, armor: ARMOR_TIERS.LEATHER, speed: 0.7, range: 140, morale: 60, cost: 65 });

        // --- SPEAR LINE ---
        this.create("Spearman", "Spearman", ROLES.PIKE, false, { weightClass: WEIGHT_CLASSES.HEAVY_INF, health: 100, meleeAttack: 14, meleeDefense: 16, armor: ARMOR_TIERS.PARTIAL_LAMELLAR, bonusVsLarge: 20, speed: 0.75, range: 30, morale: 55, cost: 10 });
        this.create("Firelance", "Firelance", ROLES.FIRELANCE, false, { weightClass: WEIGHT_CLASSES.HEAVY_INF, isRanged: true, ammo: 1, health: 100, meleeAttack: 16, meleeDefense: 14, missileBaseDamage: 14, missileAPDamage: 45, accuracy: 55, armor: ARMOR_TIERS.PARTIAL_LAMELLAR, speed: 0.8, range: 30, morale: 60, cost: 50 });
        this.create("Heavy Firelance", "Heavy Firelance", ROLES.FIRELANCE, false, { weightClass: WEIGHT_CLASSES.HEAVY_INF, isRanged: true, ammo: 2, health: 140, meleeAttack: 20, meleeDefense: 20, missileBaseDamage: 20, missileAPDamage: 60, accuracy: 60, armor: ARMOR_TIERS.FULL_LAMELLAR, speed: 0.75, range: 30, morale: 70, cost: 80 });

        // --- ARCHER LINE ---
        this.create("Archer", "Archer", ROLES.ARCHER, false, { weightClass: WEIGHT_CLASSES.LIGHT_INF, isRanged: true, ammo: 20, health: 100, meleeAttack: 8, meleeDefense: 10, missileBaseDamage: 13, missileAPDamage: 4, accuracy: 55, armor: ARMOR_TIERS.LEATHER, speed: 0.85, range: 700, morale: 50, cost: 25 });
        this.create("Horse Archer", "Horse Archer", ROLES.HORSE_ARCHER, true, { weightClass: WEIGHT_CLASSES.CAV, isRanged: true, ammo: 20, health: 120, meleeAttack: 12, meleeDefense: 12, missileBaseDamage: 11, missileAPDamage: 4, accuracy: 60, armor: ARMOR_TIERS.PARTIAL_LAMELLAR, speed: 1.6, range: 700, morale: 60, cost: 50 });
        this.create("Heavy Horse Archer", "Heavy Horse Archer", ROLES.HORSE_ARCHER, true, { weightClass: WEIGHT_CLASSES.HEAVY_CAV, isRanged: true, ammo: 20, health: 150, meleeAttack: 16, meleeDefense: 18, missileBaseDamage: 11, missileAPDamage: 6, accuracy: 65, armor: ARMOR_TIERS.FULL_LAMELLAR, speed: 1.4, range: 700, morale: 70, cost: 75 });

        // --- SABRE LINE ---
        this.create("Shielded Infantry", "Shielded Infantry", ROLES.SHIELD, false, { weightClass: WEIGHT_CLASSES.HEAVY_INF, health: 140, meleeAttack: 7, meleeDefense: 28, armor: ARMOR_TIERS.LEATHER, shieldBlockChance: 25, speed: 0.5, range: 20, morale: 60, cost: 30 });
        this.create("Light Two Handed", "Light Two Handed", ROLES.TWO_HANDED, false, { weightClass: WEIGHT_CLASSES.LIGHT_INF, health: 100, meleeAttack: 30, meleeDefense: 12, armor: ARMOR_TIERS.LEATHER, speed: 0.9, range: 20, morale: 65, cost: 35 });
        this.create("Heavy Two Handed", "Heavy Two Handed", ROLES.TWO_HANDED, false, { weightClass: WEIGHT_CLASSES.HEAVY_INF, health: 125, meleeAttack: 36, meleeDefense: 16, armor: ARMOR_TIERS.FULL_LAMELLAR, speed: 0.65, range: 20, morale: 75, cost: 60 });

        // --- SCOUT LINE ---
        this.create("Lancer", "Lancer", ROLES.CAVALRY, true, { weightClass: WEIGHT_CLASSES.CAV, health: 100, meleeAttack: 18, meleeDefense: 14, armor: ARMOR_TIERS.PARTIAL_LAMELLAR, speed: 1.5, range: 25, morale: 60, cost: 60 });
        this.create("Heavy Lancer", "Heavy Lancer", ROLES.CAVALRY, true, { weightClass: WEIGHT_CLASSES.HEAVY_CAV, health: 150, meleeAttack: 24, meleeDefense: 20, armor: ARMOR_TIERS.FULL_LAMELLAR, speed: 1.2, range: 25, morale: 75, cost: 90 });
        this.create("Elite Lancer", "Elite Lancer", ROLES.CAVALRY, true, { weightClass: WEIGHT_CLASSES.HEAVY_CAV, health: 200, meleeAttack: 28, meleeDefense: 24, armor: ARMOR_TIERS.SUPER_HEAVY + 5, speed: 1.2, range: 25, morale: 85, cost: 150 }); 

        // --- FACTION UNIQUES ---
        this.create("Rocket", "Rocket", ROLES.ROCKET, false, { weightClass: WEIGHT_CLASSES.LIGHT_INF, isRanged: true, ammo: 50, health: 130, meleeAttack: 8, meleeDefense: 8, missileBaseDamage: 15, missileAPDamage: 5, accuracy: 55, armor: ARMOR_TIERS.LEATHER, speed: 0.5, range: 520, morale: 55, cost: 55 });
        this.create("Mangudai", "Mangudai", ROLES.HORSE_ARCHER, true, { weightClass: WEIGHT_CLASSES.HEAVY_CAV, isRanged: true, ammo: 35, health: 145, meleeAttack: 18, meleeDefense: 16, missileBaseDamage: 14, missileAPDamage: 8, accuracy: 75, armor: ARMOR_TIERS.SUPER_HEAVY, speed: 1.8, range: 700, morale: 80, cost: 155 });
        this.create("Hand Cannoneer", "Hand Cannoneer", ROLES.GUNNER, false, { weightClass: WEIGHT_CLASSES.LIGHT_INF, isRanged: true, ammo: 30, health: 100, meleeAttack: 10, meleeDefense: 12, missileBaseDamage: 25, missileAPDamage: 50, accuracy: 65, armor: ARMOR_TIERS.CLOTH, speed: 0.75, range: 800, morale: 70, cost: 70 });
        this.create("Camel Cannon", "Camel Cannon", ROLES.MOUNTED_GUNNER, true, { weightClass: WEIGHT_CLASSES.CAV, isRanged: true, ammo: 60, health: 150, meleeAttack: 12, meleeDefense: 14, missileBaseDamage: 35, missileAPDamage: 80, accuracy: 40, armor: ARMOR_TIERS.CLOTH, speed: 0.75, range: 850, morale: 80, cost: 100 });
        this.create("Poison Crossbowman", "Poison Crossbowman", ROLES.CROSSBOW, false, { weightClass: WEIGHT_CLASSES.LIGHT_INF, isRanged: true, ammo: 30, health: 100, meleeAttack: 12, meleeDefense: 12, missileBaseDamage: 60, missileAPDamage: 1, accuracy: 90, armor: ARMOR_TIERS.LEATHER, speed: 0.8, range: 400, morale: 55, cost: 45 });
        this.create("War Elephant", "War Elephant", ROLES.CAVALRY, true, { weightClass: WEIGHT_CLASSES.ELEPHANT, health: 1000, meleeAttack: 35, meleeDefense: 20, armor: ARMOR_TIERS.JUGGERNAUT, speed: 0.9, range: 25, morale: 100, cost: 500 });
        this.create("Repeater Crossbowman", "Repeater Crossbowman", ROLES.CROSSBOW, false, { weightClass: WEIGHT_CLASSES.LIGHT_INF, isRanged: true, ammo: 40, health: 100, meleeAttack: 8, meleeDefense: 10, missileBaseDamage: 15, missileAPDamage: 2, accuracy: 45, armor: ARMOR_TIERS.PARTIAL_LAMELLAR, speed: 0.75, range: 700, morale: 55, cost: 40 });
        this.create("Slinger", "Slinger", ROLES.THROWING, false, { weightClass: WEIGHT_CLASSES.LIGHT_INF, isRanged: true, ammo: 30, health: 80, meleeAttack: 6, meleeDefense: 8, missileBaseDamage: 5, missileAPDamage: 7, accuracy: 50, armor: ARMOR_TIERS.CLOTH, speed: 1.0, range: 650, morale: 40, cost: 15 });
        this.create("Glaiveman", "Glaiveman", ROLES.INFANTRY, false, { weightClass: WEIGHT_CLASSES.HEAVY_INF, health: 100, meleeAttack: 18, meleeDefense: 14, armor: ARMOR_TIERS.PARTIAL_LAMELLAR, speed: 0.75, range: 20, morale: 65, cost: 45 });
        
        // --- EXISTING NON-GUI UNITS ---
        this.create("Javelinier", "Javelinier", ROLES.THROWING, false, { weightClass: WEIGHT_CLASSES.LIGHT_INF, isRanged: true, ammo: 4, health: 100, meleeAttack: 10, meleeDefense: 10, missileBaseDamage: 18, missileAPDamage: 15, accuracy: 50, armor: ARMOR_TIERS.LEATHER, speed: 0.85, range: 300, morale: 50, cost: 25 });
    }
};
