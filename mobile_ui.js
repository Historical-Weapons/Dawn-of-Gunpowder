...
/* ──────────────────────────────────────────
       ...
       ────────────────────────────────────────── */
    #diplomacy-panel {
        width: 100vw !important;  /* Full width of the phone */
        height: 90vh !important; /* Maximized height (leaving 10% for background view) */
        top: 50% !important;      /* Center vertically */
        left: 0 !important;       /* Start at the very edge */
        transform: translateY(-50%) !important; 
        padding: 5px !important;
        box-sizing: border-box !important;
        border-radius: 0 !important; /* Square corners look better full-screen */
        z-index: 10001 !important;
        /* display: handled by game logic */
    }

    #diplomacy-table-container {
        overflow: auto !important; /* RE-ENABLES BOTH SCROLLBARS */
        -webkit-overflow-scrolling: touch !important; /* Smooth iOS momentum */
        width: 100% !important;
        height: calc(100% - 30px) !important; /* Maximize table area */
        display: block !important;
        background: rgba(0,0,0,0.4) !important;
    }

    .dip-table {
        min-width: 900px !important; /* Force extra width so it HAS to scroll horizontally */
        font-size: 9px !important;   /* TINY FONT to fit more columns */
        border-collapse: collapse !important;
    }

    .dip-table td, .dip-table th {
        padding: 3px 1px !important; /* TIGHTEST padding possible */
        height: 25px !important;     /* Consistent row height */
        border: 1px solid rgba(212,184,134,0.2) !important;
    }
    ...
    .dip-row-label {
        ...
        z-index: 15 !important; /* Above table content */
...
// ============================================================================
// DAWN OF GUNPOWDER — MOBILE UI ADAPTER  (mobile_ui.js)
// ============================================================================
// Load order: Place this <script> tag LAST in index.html, after all other JS.
//
// What this file does:
//   • Injects a global responsive CSS stylesheet
//   • On mobile/tablet (≤900px wide OR touch device):
//       - Hides #ui (top-left stats) and #diplomacy-container (top-right)
//       - Adds a floating "≡ DETAIL" button (top-right)
//       - Opens a full-panel drawer containing all overworld info + troop data
//   • Patches the Main Menu title/buttons for small screens
//   • Patches the Loading Screen layout for portrait phones
//   • Patches the Custom Battle GUI header/body for mobile
//   • Patches the TroopGUI overlay for mobile
//   • Scales the City Panel, Siege GUI, and Siege Sally panel for mobile
//   • Adds a CONTROLS placeholder section (no existing logic removed)
//   • All patches re-run on window resize (responsive)
// ============================================================================
