...
// C. LOOT SYSTEM & CARGO TRANSFER
    if (enemyRef) {
        ...
        // Cargo capacity based on troop count
        playerObj.cargoCapacity = Math.max(50, (playerObj.roster.length || 1) * 5);
            ...
            if (enemyRef.cargo && Object.keys(enemyRef.cargo).length > 0) {
                ...
                Object.keys(enemyRef.cargo).forEach(rid => {
                    ...
                    if (qty > 0) {
                        ...
                        // Guarantee at least 1 item drops if the win severity is high enough to trigger the chance
                        ...
                        if (stolenQty > freeSpace) {
                            ...
                            stolenQty = Math.max(0, freeSpace);
                        }
